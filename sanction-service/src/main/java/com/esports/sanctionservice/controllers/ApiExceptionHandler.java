...
//atrapa todos os errores y los devuelve como JSON
@RestControllerAdvice
public class ApiExceptionHandler  {

    //esto atrapara errores de validacion como notblanck y notnull
    ...
    //esto captura la exception personalizada SancionException
